...
template <class T>
SettingRenderParameter* Visualizer<T>::initVTKDimension(int _bSchermo, int _hSchermo)
{
    SettingRenderParameter* settingRenderParameter = new SettingRenderParameter();
//    settingRenderParameter->renderWindow->AddRenderer(settingRenderParameter->m_renderer);

//    settingRenderParameter-> interactor->SetRenderWindow( settingRenderParameter->renderWindow);
//    settingRenderParameter->m_renderer->SetBackground( settingRenderParameter->colors->GetColor3d("Silver").GetData());
//    settingRenderParameter-> renderWindow->SetSize(_bSchermo, _hSchermo);
//    // An interactor
...
//    settingRenderParameter->interactor->SetInteractorStyle(style);
//    settingRenderParameter->renderWindow->SetWindowName("QtVtkVisualizer");


    return  settingRenderParameter;
